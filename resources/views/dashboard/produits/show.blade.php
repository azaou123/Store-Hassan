            ...
            <div class="container py-5">
                <div class="row mb-4">
                    <div class="lc-block text-center">
                        <div editable="rich">
                            <h2 class="fw-bold display-2">{{ $produit->label }}</h2>
                        </div>
                    </div>
                    <div class="lc-block text-center">
                        <div editable="rich">
                ...
                <div class="row">
                    ...
                    @foreach($imageFiles as $imageFile)
                        <div class="col-md-6 col-lg-4 g-4">
                            <div class="lc-block">
                                <img class="img-fluid w-100 rounded-5" src="{{ asset('storage/' . $produit->repPhotos . '/' . $imageFile->getFilename()) }}" style="height: 300px;" alt="Photo by Bekky Bekks" loading="lazy">
                            </div>
                            <!-- /lc-block -->
                        </div>
                    @endforeach
