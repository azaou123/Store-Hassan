        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <a href="{{ route('profile') }}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="{{ route('commandes') }}" class="nav-item nav-link active"><i class="fas fa-list-alt me-2"></i>Commandes</a>
                    ...
                    <a href="{{ route('opinions') }}" class="nav-item nav-link"><i class="fa-solid fa-handshake"></i></i>Partenaires</a>
                    ...
                    <script>
                        function showProducts(listeProduits,a,b,c) {
                            ...
                            function createTr(p1,p2,p3) {
                                ...
                                document.getElementById('total').innerText = parseFloat(document.getElementById('total').innerText) + p2 * p3;
                            }
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="text-light">
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary" data-toggle="modal" onclick="showProducts(
                                        ...
                                        <a class="btn btn-sm btn-success" href="{{ route('commande.validate', ['commande'=>$command->id]) }}">
                                            <i class="bi bi-check"></i>
                                        </a>
                                        <a class="btn btn-sm btn-warning" href="{{ route('commande.discard', ['commande'=>$command->id]) }}">
                                            <i class="bi bi-x"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger" href="{{ route('commande.delete', ['commande'=>$command->id]) }}">
