        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <a href="{{ route('profile') }}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="{{ route('opinions') }}" class="nav-item nav-link active"><i class="fas fa-comments me-2"></i>Opinions</a>
                    <a href="{{ route('partenaires') }}" class="nav-item nav-link"><i class="fas fa-handshake me-2"></i>Partenaires</a>
                            ...
                            <div class="modal-dialog">
                                ...
                                <form action="{{ route('addOpinion') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control bg-light text-dark " id="opinion" name="opinion" rows="3" required></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control bg-light text-dark" id="photo" name="photo">
                                    </div>
                            ...
                            @foreach ($opinions as $opinion)
                                <div class="col-md-4 mb-4 mb-md-0">
                                    <div class="d-flex justify-content-center mb-4">
                                        <img src="{{ asset('storage/'.$opinion->photo) }}" class="rounded-circle shadow-1-strong" width="100" height="100" />
                                    </div>
                                    <p class="lead my-3 text-muted">
                                        {{ $opinion->opinion }}
                                    </p>
                                    <p class="font-italic font-weight-normal mb-0">- {{ $opinion->name }}</p>
                                    <a class="col-3 fs-4" href="{{ route('opinions.destroy', ['id' => $opinion->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $opinion->id }}').submit();">
                                        ---
                                    ...
                                    <!-- Form for deletion -->
                                    <form id="delete-form-{{ $opinion->id }}" action="{{ route('opinions.destroy', ['id' => $opinion->id]) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
